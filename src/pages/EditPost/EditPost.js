...
const EditPost = () => {
    ...
    //pegamos separadamente os atributos do post
    useEffect(() => {
        if (post) {
            setTitle(post.title);
            setBody(post.body)
    ...
    return (
        <div className={styles.edit_post}>
            {post && (
                <>
                    <h2>Editar</h2>
                    <p>Alterando os dados do post: {post.title}</p>
                    <form onSubmit={handleSubmit}>
                        ...
                        <label>
                            ...
                            name="body"
                            required
                            placeholder='Insira a sua legenda'
